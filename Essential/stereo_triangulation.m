function [XL,XR] = stereo_triangulation(xL,xR,R,T),
...
%
% Input:
%           xL: 2xN matrix of normalized pixel coordinates in the left image
%           xR: 2xN matrix of normalized pixel coordinates in the right image
...
%
%
% (c) Jean-Yves Bouguet - Intel Corporation - April 9th, 2003 // with
% remarks By Tigran
